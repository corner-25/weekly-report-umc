...
/**
 * Upload Excel số liệu Phòng HC thủ công — phương án dự phòng.
 *
 * Luồng chính là đồng bộ tự động từ OneDrive (xem docs/INGESTION-REFACTOR.md).
 * Panel này giữ lại cho lúc OneDrive hỏng hoặc cần nạp gấp ngoài lịch.
 */
    ...
    <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-blue-500 to-cyan-500 px-5 py-4">
        ...
        <p className="text-blue-100 text-xs mt-1">
          Upload file Excel → Kiểm tra → Ghi vào hệ thống
        </p>
      </div>
      ...
      <div className="p-5 space-y-4">
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-lg p-3 text-xs text-blue-700">
          ...
          <div className="flex items-center gap-1 flex-wrap">
            ...
            <span>→</span>
            <span className="bg-white px-2 py-0.5 rounded border border-blue-200">Database</span>
          </div>
        ...
        <div className="text-xs text-slate-400 bg-slate-50 rounded-lg p-3">
          ...
          <p><span className="font-medium">Lưu ý:</span> chỉ thêm dòng mới, không ghi đè số liệu đã có trong hệ thống</p>
